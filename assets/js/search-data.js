      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-第31回-計算工学講演会にて口頭発表-基調講演-を行いました",
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-hors40th記念合同現地観測キャンペーンに参加しました",
          title: 'HORS40th記念合同現地観測キャンペーンに参加しました',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/2026-08-31-observation/";
            },},{id: "projects-高精度sph法",
          title: '高精度SPH法',
